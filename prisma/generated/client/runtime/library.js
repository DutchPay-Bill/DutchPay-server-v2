...
var X = (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports),
  Or = (e, r) => {
    for (var t in r) At(e, t, { get: r[t], enumerable: !0 });
  },
  to = (e, r, t, n) => {
...
var _ = (e, r, t) => (
    ...
    to(
      r || !e || !e.__esModule
        ? At(t, 'default', { value: e, enumerable: !0 })
        : t,
      e,
    )
  ),
  Bl = (e) => to(At({}, '__esModule', { value: !0 }), e);
var bo = X((Rd, Vn) => {
  'use strict';
  var v = Vn.exports;
  ...
  var D = '\x1B[',
    ...
    dr = '\x07',
    Nt = ';',
    Eo = process.env.TERM_PROGRAM === 'Apple_Terminal';
  v.cursorTo = (e, r) => {
    if (typeof e != 'number')
...
`,
  ...
  function Mu(e) {
    let r = qo.resolve(process.cwd(), '.env'),
      t = 'utf8',
      n = !!(e && e.debug),
      i = !!(e && e.override);
    e &&
      (e.path != null && (r = Fu(e.path)),
...
typeof process < 'u' &&
  ...
  (uo = process.stdout && process.stdout.isTTY));
var co = {
  enabled:
    !so && ao == null && lo !== 'dumb' && ((Nn != null && Nn !== '0') || uo),
};
function F(e, r) {
...
globalThis.DEBUG_COLORS ??
  (globalThis.DEBUG_COLORS = process.env.DEBUG_COLORS
  ...
  we = (e, r, t) => {
    ...
    if ($n(e)) {
      ...
      return Object.keys(e).every((n) => {
        let i = e[n];
        return (
          (n in r || (Dt((o = i)) && o[ke]().matcherType === 'optional')) &&
          we(i, r[n], t)
        );
        var o;
      });
...
var yu = (0, Lo.promisify)(Do.default.exec),
  ie = N('prisma:get-platform'),
  Eu = ['1.0.x', '1.1.x', '3.0.x'];
async function No() {
  let e = Ft.default.platform(),
    r = process.arch;
  if (e === 'freebsd') {
  ...
  let t = await wu(),
    n = await Au(),
    i = Pu({ arch: r, archFromUname: n, familyDistro: t.familyDistro }),
    { libssl: o } = await vu(i);
  ...
  return mr(e)
    ...
    .otherwise(
      ({ familyDistro: r, arch: t, archFromUname: n }) => (
        ie(`Don't know any platform-specific paths for "${r}" on ${t} (${n})`),
        []
      ),
    );
}
...
async function Tu(e) {
  try {
    return (await Hn.default.readdir(e)).find(
...
var Ot = {};
async function Fo() {
  if (Cu(Ot)) return Promise.resolve({ ...Ot, memoized: !0 });
  let e = await No(),
    r = Su(e);
  return (Ot = { ...e, binaryTarget: r }), { ...Ot, memoized: !1 };
}
function Su(e) {
  let {
    platform: r,
...
${c}`);
  ...
  if (
    (r === 'linux' &&
      o === void 0 &&
      Ur(`Prisma doesn't know which engines to download for the Linux distro "${a}". Falling back to Prisma engines built "${u}".
Please report your experience by creating an issue at ${jr('https://github.com/prisma/prisma/issues')} so we can add your distro to the list of known supported distros.`),
    r === 'darwin' && t === 'arm64')
  )
    return 'darwin-arm64';
...
async function Au() {
  return typeof Ft.default.machine == 'function'
    ? Ft.default.machine()
    : (await Mt('uname -m'))?.trim();
}
function Mo(e) {
...
function $u(e, r, t) {
  ...
  if (n && r && i && Bt.default.existsSync(r)) {
    let o = Yn.default.parse(Bt.default.readFileSync(r)),
      s = [];
...
function ti(e) {
  let r = e.e,
    ...
    i = `Please refer to the documentation about Prisma's system requirements: ${jr('https://pris.ly/d/system-requirements')}`,
...
function ni(e) {
  return Jr.default.sep === Jr.default.posix.sep
    ? e
    : e.split(Jr.default.sep).join(Jr.default.posix.sep);
}
var Zo = _(ii());
function si(e) {
  ...
  toString() {
    let { config: r } = this,
      t = r.provider.fromEnvVar
        ...
        : r.provider.value,
      n = JSON.parse(
        JSON.stringify({ provider: t, binaryTargets: Gu(r.binaryTargets) }),
      );
...
var Hr = {
  ...
  Xo = { warn: () => !process.env.PRISMA_DISABLE_WARNINGS };
function Wu(...e) {
  console.log(...e);
}
function ai(e, ...r) {
...
function Xu(e) {
  return {
    datamodel: { models: mi(e.models), enums: mi(e.enums), types: mi(e.types) },
  };
}
function mi(e) {
...
var Jt = {
  classes: { DbNull: Zr, JsonNull: Xr, AnyNull: et },
  instances: { DbNull: new Zr(Gt), JsonNull: new Xr(Gt), AnyNull: new et(Gt) },
};
function fi(e, r) {
  Object.defineProperty(e, 'name', { value: r, configurable: !0 });
}
...
var gi = class {
  ...
  hi = (e) => {
    ...
    return (
      e.getConnectionInfo &&
        (n.getConnectionInfo = rc(r, e.getConnectionInfo.bind(e))),
      n
    );
  },
  ec = (e, r) => ({
...
var cs = require('util');
var Ht = { enumerable: !0, configurable: !0, writable: !0 };
function Wt(e) {
  let r = new Set(e);
  return {
...
function Pe(e, r) {
  let t = tc(r),
    ...
    i = new Proxy(e, {
      ...
      ownKeys(o) {
        let s = us(Reflect.ownKeys(o), t),
          a = us(Array.from(t.keys()), t);
  ...
  return (
    (i[ls] = function (o, s, a = cs.inspect) {
      let l = { ...this };
...
var xr = 9e15,
  ...
  x = !0,
  en = '[DecimalError] ',
  Ge = en + 'Invalid argument: ',
  hs = en + 'Precision limit exceeded',
  ys = en + 'crypto unavailable',
  Es = '[object Decimal]',
  re = Math.floor,
  Q = Math.pow,
  nc = /^0b([01]+(\.[01]*)?|\.[01]+)(p[+-]?\d+)?$/i,
  ic = /^0x([0-9a-f]+(\.[0-9a-f]*)?|\.[0-9a-f]+)(p[+-]?\d+)?$/i,
  oc = /^0o([0-7]+(\.[0-7]*)?|\.[0-7]+)(p[+-]?\d+)?$/i,
  bs = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i,
  he = 1e7,
  b = 7,
  sc = 9007199254740991,
...
d.hyperbolicCosine = d.cosh = function () {
  ...
  (t = s.precision),
    ...
    (i = o.d.length),
    i < 32
      ? ((e = Math.ceil(i / 3)), (r = (1 / tn(4, e)).toString()))
  ...
  return (
    ...
    r > l.maxE + 1 || r < l.minE - 1
      ...
      : ((x = !1),
        ...
        (i = Pi(e.times(Qe(a, n + t)), n)),
        i.d &&
          ((i = y(i, n + 5, 1)),
          it(i.d, n, o) &&
            ((r = n + 10),
            (i = y(Pi(e.times(Qe(a, r + t)), r), r + 5, 1)),
...
function lc(e, r) {
  ...
  (n = r.d.length),
    n < 32
      ? ((t = Math.ceil(n / 3)), (i = (1 / tn(4, t)).toString()))
...
var O = (function () {
  ...
  return function (n, i, o, s, a, l) {
    ...
    if (
      (L[p] > (Z[p] || 0) && c--,
      o == null
        ? ((le = o = Rt.precision), (s = Rt.rounding))
        : a
          ? (le = o + (n.e - i.e) + 1)
          : (le = o),
      le < 0)
...
function Qe(e, r) {
  ...
  for (
    ...
    if (
      ...
      if (
        ((l = l.times(2)),
        o !== 0 && (l = l.plus(Xt(T, c + 2, E).times(o + ''))),
        (l = O(l, new T(f), c, 1)),
        r == null)
      )
        if (it(l.d, c - g, C, a))
...
function vc(e) {
  ...
  for (r = 0; r < o.length; r += 3)
    if (((t = o[r]), i && (this[t] = wi[t]), (n = e[t]) !== void 0))
      if (re(n) === n && n >= o[r + 1] && n <= o[r + 2]) this[t] = n;
      else throw Error(Ge + t + ': ' + n);
  if (((t = 'crypto'), i && (this[t] = wi[t]), (n = e[t]) !== void 0))
    if (n === !0 || n === !1 || n === 0 || n === 1)
      if (n)
        if (
          typeof crypto < 'u' &&
...
var on = (e) => e,
  ...
  Ss = { bold: W, red: ce, green: $e, dim: Ie, enabled: !0 },
  Cr = {
    write(e) {
      e.writeLine(',');
    },
...
var op =
  ...
  sp = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i;
function ap(e) {
  var r = op.exec(e);
  if (!r) return null;
...
var $s = (e) => (Array.isArray(e) ? e : e.split('.')),
  Ai = (e, r) => $s(r).reduce((t, n) => t && t[n], e),
  qs = (e, r, t) =>
    $s(r).reduceRight(
      (n, i, o, s) => Object.assign({}, Ai(e, s.slice(0, o)), { [i]: n }),
      t,
    );
function Ep(e, r) {
...
var xp = (e) => e,
  ...
  P = {
    ...
    disableWorkerMessageHandler:
      cn.Prism && cn.Prism.disableWorkerMessageHandler,
    util: {
      encode: function (e) {
        if (e instanceof ye) {
          let r = e;
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, '__id', { value: ++Pp }), e.__id
        );
      },
...
var ki = Symbol();
function at(e) {
  let r = [qp(e), te(ki, () => e), te('$parent', () => e._appliedParent)],
...
function Zs({
  ...
  return n.isEmpty() || e == null || typeof e != 'object' || !i.models[r]
    ...
    : mn({
        ...
        runtimeDataModel: i,
        visitor: (s, a, l) =>
          zs({ result: s, modelName: Se(a), select: l.select, extensions: n }),
      });
}
function Xs(e) {
...
function gn() {
  return typeof Netlify == 'object'
    ...
    : typeof EdgeRuntime == 'string'
      ? 'edge-light'
      : globalThis.navigator?.userAgent === Gp
        ? 'workerd'
        : globalThis.Deno
          ? 'deno'
          : globalThis.__lagon__
            ? 'lagon'
            : globalThis.process?.release?.name === Jp
              ? 'node'
              : globalThis.Bun
                ? 'bun'
                : globalThis.fastly
...
var Wp = N('prisma:client:engines:resolveEnginePath'),
  Kp = () => new RegExp('runtime[\\\\/]library\\.m?js$');
async function Ea(e, r) {
  ...
  if (
    (Wp('enginePath', n), n !== void 0 && e === 'binary' && ri(n), n !== void 0)
  )
  ...
  let o = await rr(),
    ...
    p;
  throw (
    (a && l ? (p = ga(c)) : l ? (p = da(c)) : u ? (p = fa(c)) : (p = ha(c)),
...
async function zp(engineType, config) {
  ...
  for (let e of searchLocations) {
    let r = ba(engineType, binaryTarget),
      t = ut.default.join(e, r);
  ...
  return new Promise((s, a) => {
    let l = t.request(e, n, (u) => {
      ...
      c >= 301 &&
        c <= 399 &&
        p &&
        (p.startsWith('http') === !1 ? s(qi(`${o}${p}`, r)) : s(qi(p, r))),
...
var sm = /^[1-9][0-9]*\.[0-9]+\.[0-9]+$/,
  _a = N('prisma:client:dataproxyEngine');
async function am(e, r) {
  let t = Ia['@prisma/engines-version'],
...
var Da = 3,
  Vi = N('prisma:client:dataproxyEngine'),
  ji = class {
    constructor({
      apiKey: r,
      tracingHelper: t,
      ...
      this.startPromise !== void 0 && (await this.startPromise),
        (this.startPromise = (async () => {
          ...
          (this.host = r),
            ...
            (this.remoteClientVersion = await ka(r, this.config)),
            Vi('host', this.host);
        })()),
    ...
    requestInternal({
      ...
      return this.withRetry({
        ...
        callback: async ({ logHttpCall: o }) => {
          ...
          a.ok || Vi('graphql response status', a.status),
...
function cm(e) {
  ...
  return (
    process.platform !== 'win32' &&
      (i =
        Qi.default.constants.dlopen.RTLD_LAZY |
        Qi.default.constants.dlopen.RTLD_DEEPBIND),
...
var Gi,
  Fa = {
    async loadLibrary(e) {
      ...
      if (t === void 0)
        throw new S(
          `The \`adapter\` option for \`PrismaClient\` is required in this context (${gn()})`,
          r,
        );
      if (n === void 0)
...
var Ma = [...Mn, 'native'],
  ...
  vt = class {
    constructor(r, t) {
      ...
      (this.libraryLoader = t ?? Oa),
        r.engineWasm !== void 0 && (this.libraryLoader = t ?? Fa),
        (this.config = r),
    ...
    async getCurrentBinaryTarget() {
      {
        ...
        if (!Ma.includes(r))
          throw new S(
            `Unknown ${ce('PRISMA_QUERY_ENGINE_LIBRARY')} ${ce(W(r))}. Possible binaryTargets: ${$e(Ma.join(', '))} or a path to the query engine library.
...
${a.backtrace}`,
    ...
    buildQueryError(r) {
      if (r.user_facing_error.is_panic)
        return new ue(
          Ji(this, r.user_facing_error.message),
          this.config.clientVersion,
        );
...
function bm(e, r) {
  ...
  r.addErrorMessage((s) => {
    ...
    return (
      i ? (a += ` on model ${s.bold(i.name)}. ${Tt(s)}`) : (a += '.'),
      (a += `
...
function wm(e, r) {
  let t = e.outputType,
    ...
    i = n?.isEmpty() ?? !1;
  n && (n.removeAllFields(), Wa(n, t)),
    r.addErrorMessage((o) =>
      i
        ? `The ${o.red('`select`')} statement for type ${o.bold(t.name)} must not be empty. ${Tt(o)}`
...
function Pm(e, r) {
  ...
  n instanceof J && (n.getField(t)?.markAsError(), _m(n, e.arguments)),
    r.addErrorMessage((i) =>
      Ja(
        i,
        t,
...
function Fm(e, r, t) {
  for (let [n, i] of Object.entries(r)) {
    ...
    o &&
      ...
      i === !0
        ? (e[n] = !0)
        : typeof i == 'object' && (e[n] = Ki(i, t.nestSelection(n)));
  }
}
function Mm(e, r) {
  let t = {},
  ...
  for (let [o, s] of Object.entries(i)) {
    ...
    (n?.[o] && !a) ||
      (s === !0
        ? (t[o] = !0)
        : typeof s == 'object' && (t[o] = Ki(s, r.nestSelection(o))));
  }
  return t;
}
function Ya(e, r) {
    ...
    (t) => {
      ...
      if (Array.isArray(t)) {
        ...
        switch (r) {
          ...
          case 'mysql': {
            (n = t.sql),
              (i = { values: Ct(t.values), __prismaRawParameters__: !0 });
            break;
          }
          case 'cockroachdb':
          case 'postgresql':
...
function dl(e) {
  ...
  return (
    ...
    e.query.arguments && r.push(eo(e.query.arguments)),
    r.push(eo(e.query.selection)),
    r.join('')
  );
}
function eo(e) {
        ...
        (this.dataloader = new In({
          batchLoader: na(async ({ requests: n, customDataProxyFetch: i }) => {
            let { transaction: o, otelParentCtx: s } = n[0],
              ...
              u = n.some((p) => ro(p.protocolQuery.action));
            return (
          ...
          singleLoader: async (n) => {
            let i = n.transaction?.kind === 'itx' ? gl(n.transaction) : void 0,
...
var rd = {
  ...
  td = Symbol.for('prisma.client.transaction.id'),
  nd = {
    id: 0,
    nextId() {
      return ++this.id;
  ...
  class r {
    constructor(n) {
      ...
      let i = n?.adapter ? hi(n.adapter) : void 0,
        o = new _l.EventEmitter().on('error', () => {});
      (this._extensions = fn.empty()),
        (this._previewFeatures = wn(e)),
        (this._clientVersion = e.clientVersion ?? El),
        (this._activeProvider = e.activeProvider),
        (this._tracingHelper = ul(this._previewFeatures));
      let s = {
          rootEnvPath:
            e.relativeEnvPaths.rootEnvPath &&
            St.default.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath),
          schemaEnvPath:
            e.relativeEnvPaths.schemaEnvPath &&
            St.default.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
        },
        a = (!i && Qr(s, { conflictCheck: 'none' })) || e.injectableEdgeEnv?.();
      try {
        let l = n ?? {},
          u = l.__internal ?? {},
          c = u.debug === !0;
        ...
        kl.default.existsSync(p) || (p = e.dirname),
        ...
        if (
          ...
          (this._engine = qa(e, this._engineConfig)),
          (this._requestHandler = new _n(this, o)),
          l.log)
        )
          for (let f of l.log) {
            let g =
    ...
    $executeRawInternal(n, i, o, s) {
      ...
      return this._request({
        ...
        transaction: n,
        clientMethod: i,
        argsMapper: Yi({ clientMethod: i, activeProvider: a }),
    ...
    _request(n) {
      ...
      return this._tracingHelper.runInChildSpan(s.operation, () =>
        new Il.AsyncResource('prisma-client-request').runInAsyncScope(() =>
          l(o),
        ),
      );
    }
